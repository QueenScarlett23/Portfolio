...
public class FactoryRangedBuilding : MonoBehaviour
{
    public int team = 0;
    ...
    void SpawnUnit()
    {
        GameObject u = Instantiate(rangedUnit, new Vector3(gameObject.transform.position.x, gameObject.transform.position.y + 1.3f, gameObject.transform.position.z), Quaternion.identity) as GameObject;
        u.GetComponent<RangedUnit>().ChangeTeam(team);
    }
}
